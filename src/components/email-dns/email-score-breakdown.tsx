...
import type { EmailScoreBreakdown as EmailScoreBreakdownType } from "@/types/email-scan";
import { cn } from "@/lib/utils";

interface Props {
  breakdown: EmailScoreBreakdownType;
}

const categories: { key: keyof EmailScoreBreakdownType; label: string }[] = [
...
export function EmailScoreBreakdown({ breakdown }: Props) {
